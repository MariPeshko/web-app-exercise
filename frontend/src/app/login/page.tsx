    ...
    <main className="flex min-h-screen items-center justify-center px-6 pt-20">
      ...
      >
        ...
        <motion.div variants={staggerChild} className="mb-8 text-center">
          ...
          <h1 className="mt-4 font-heading text-3xl font-black uppercase">Welcome Back</h1>
          <p className="mt-2 text-muted-foreground">Log in to continue studying with your friends</p>
        </motion.div>
